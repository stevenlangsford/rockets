...
var instructionlist = [dev ? "Development version: <button onclick='startExp()'>Skip instructions</button>" : "Hi! These are the instructions. Please read them carefully, there will be a short quiz at the end.", "This is part of a study being run by the University of Michigan. By clicking 'Next', you are agreeing to take part in it. To participate, you must be over 18. You should know that you're free to withdraw at any time (although you'll only be paid on completion), and that although data gained from this study may be published or viewed by University of Michigan staff and relevant government offices, you will not be identified and your personal details will not be divulged, nor will anything be linked to your Turk Id. Any identifiable data will be used for administration only and deleted on completion of the study, non-identifiable data may be used in future research. </br><span style=\"font-size:.8em\">Please direct any questions about this study to Steven Langsford, reachable at <strong>slangsfo at umich dot edu</strong>. The principle investigator is Prof. Richard Lewis. If you have concerns regarding the ethics of this study and don't want to contact the investigators directly, you can contact the Health Sciences and Behavioral Sciences review board at irbhsbs at umich dot edu or phone: (734) 936-0933 or toll free, (866) 936-0933</span>","This study takes about 15 minutes, please only continue if you have 15 minutes free without interruptions. Although you will not directly benefit from being in this study, the results will help build more accurate descriptions of how people make decisions. We don't believe there are any risks from participating in this research.",
		       ...
		       "This study is about choice and decision making. The stimuli are toy rockets. You're trying to choose the best rocket from the options available.","Rockets have two stages, a launch stage on the bottom and a orbital stage on the top. They're both equally important to the performance of the rocket.","The launch stage is the black bottom part of the rocket. They vary in size, taller is always better for launch stage. There are two kinds of launch stage, straight-sides and angle-sides. There's no difference between the two kinds, both formats are equally good.<img class='demoimg' src=\"img\\basedemo.jpg\">","The orbital stage is the top part of the rocket. There are two kinds of orbital stage as well, one with a grey bar and one with a color patch. For rockets with a grey bar, taller bars are better. For rockets with a color patch, colors that have more yellow are better, colors that have more blue are worse. Again there's no difference between the two kinds, both formats are equally good.<img class='demoimg' src=\"img\\orbitaldemo.jpg\">", "The two stages are equally important, and they multiply together to get the overall performance score. This means that if one of the stages is bad, the whole rocket will be pretty bad, even if the other stage is quite good. Ideally you want both launch stage and orbital stage to be good.", "The first task gives you some practice with the rockets. You'll be shown two rockets, and you'll be able to set one of the features on one of the rockets with a slider. The task is to change the feature you control until the performance scores of the two rockets match. For the first few, you'll see the performance scores on the screen, which is essentially telling you the answer. But after that intro task the scores will be hidden and you'll have to judge when the two rockets match just by looking at the launch stage and orbital stage features.", "In the second task, you'll be asked to judge the stages individually, identifying either the rocket with the best launch stage or the best orbital stage. Choose a rocket by clicking on it.","The third task asks you to choose the best rocket from a set, combining both the launch stage and orbital stage to get the overall performance.","You'll be asked to pick the best of two or three rockets. Choose a rocket by clicking on it. The best rocket is the one with the best combination of launch stage and orbital stage. Then you're done! We expect the whole thing to take around 15 minutes.","Just to recap the most important part: The two stages of the rocket are equally important. They multiply together, so a bad score on one can spoil the whole thing. For the launch stage part at the bottom, taller is better. For the orbital stage part at the top, higher bars are better for rockets with a grey bar, colors that are more-yellow and less-blue are better for rockets with a color patch.","Some of the trials are easy, some are quite difficult. Please just give it your best shot."];
...
function quiz(){
	...
	"<strong>Which color indicates a rocket has a better orbital stage for rockets with a color-patch?</strong></br>"+
	...
	"</span>"+
	"<span style='text-align:left'><p>"+
	"<strong>What kind of launch stage gives the best performance? </strong></br>"+
	...
	"<span style='text-align:left'><p>"+
	 ...
	 "<input type='radio' name='q3' id='q3c' value='c'>&nbsp The launch stage is more important, orbital stage acts as a tie-breaker.<br/>"+
	 "<input type='radio' name='q3' id='q3d' value='d'>&nbsp The orbital stage is more important, launch stage acts as a tie-breaker. <br/>"+
	"</span>"+
...
function demographics(){
	...
	"</td></tr>"+
	"<tr><td>"+
	"Do you have any form of colorblindness? <input type=\"radio\" name=\"colblind\" id=\"yes\" value=\"yes\">&nbsp Yes&nbsp&nbsp"+
	"<input type=\"radio\" name=\"colblind\" id=\"no\" value=\"no\">&nbsp No&nbsp&nbsp"+
	"</td></tr>"+
	"<tr><td>"+
